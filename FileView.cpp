...
void CFileView::FillFileView() {
  ...
  HTREEITEM hSrc =
      m_wndFileView.InsertItem(_T("FakeApp Source Files"), 0, 0, hRoot);
  ...
  HTREEITEM hInc =
      m_wndFileView.InsertItem(_T("FakeApp Header Files"), 0, 0, hRoot);
  ...
  HTREEITEM hRes =
      m_wndFileView.InsertItem(_T("FakeApp Resource Files"), 0, 0, hRoot);
...
void CFileView::AdjustLayout() {
  ...
  m_wndToolBar.SetWindowPos(nullptr, rectClient.left, rectClient.top,
                            rectClient.Width(), cyTlb,
                            SWP_NOACTIVATE | SWP_NOZORDER);
  m_wndFileView.SetWindowPos(nullptr, rectClient.left + 1,
...
void CFileView::OnChangeVisualStyle() {
  ...
  m_wndToolBar.LoadBitmap(
      theApp.m_bHiColorIcons ? IDB_EXPLORER_24 : IDR_EXPLORER, 0, 0,
      TRUE /* Locked */);
