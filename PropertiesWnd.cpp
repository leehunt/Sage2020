...
BEGIN_MESSAGE_MAP(CPropertiesWnd, CDockablePane)
  ...
  ON_UPDATE_COMMAND_UI(ID_EXPAND_ALL,
                       &CPropertiesWnd::OnUpdateExpandAllProperties)
...
void CPropertiesWnd::OnProperties1() {
  // N.b. Add your command handler code here
}

void CPropertiesWnd::OnUpdateProperties1(CCmdUI* /*pCmdUI*/) {
  // N.b. Add your command update UI handler code here
}
...
void CPropertiesWnd::UpdateGridBlock(
  ...
  if (pPropVersionComment != NULL) {
    ...
    if (!(pPropVersionComment->GetValue() == varWzCommentT)) {
      ...
      // Take over Description with comment.  THIS DOESN'T WORK (INVALIDATION
